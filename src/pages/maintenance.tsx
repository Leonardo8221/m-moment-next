            ...
            <div className="flex flex-col bg-white pt-[134px] justify-between pb-[64px] w-[720px] h-[400px] relative border border-black/10 rounded-[10px]">
              ...
              <div className="flex flex-col justify-center items-center">
                ...
                <p className="font-[JetBrainsMono] text-[16px] font-normal text-[--dark] text-center mb-[33px]">
                  Sorry for the inconvenience. We’re performing some <br />
                  maintenance at the moment. We&rsquo;ll be back up shortly!
                </p>
                <p className="font-[JetBrainsMono] text-[15px] font-normal text-[--dark] text-center mb-[33px]">
                  — The MessageMoment Team
                </p>
              </div>
            </div>
          </div>
