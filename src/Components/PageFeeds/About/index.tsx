    ...
    <div className="flex flex-col">
      ...
      <div className="w-full h-[723px] relative flex flex-col items-center pt-[155px] pb-[70px]">
        ...
        <button
          ...
          className="w-[315px] h-[46px] inline-flex items-center justify-center text-white bg-[--blue] font-[JetBrainsMono] text-[15px] text-center rounded-[5px] !transition-all !duration-500 !ease-in-out hover:!bg-[--hoverblue]"
        >
          Try MessageMoment
        </button>
      </div>
